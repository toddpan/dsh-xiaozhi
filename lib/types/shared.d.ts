 ...
 */
export declare const ADMIN_BASE = "/dsh-xiaozhi/admin";
/**
 ...
 */
export declare const ADMIN_CSRF_HEADER = "x-dsh-xiaozhi-admin";
 ...
 */
export declare const CONNECTION_TONES: Record<ConnectionState, ConnectionTone>;
/** Connection states in display order, for the page's legend and tests. */
export declare const CONNECTION_STATES: ConnectionState[];
